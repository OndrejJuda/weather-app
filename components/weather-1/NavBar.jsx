...
const className = 'h-8 w-[calc(100%-8px)] -ml-[8px] text-gray-600 flex justify-center items-center border-l-8 hover:border-gray-900';

const NavBar = () => {
  return (
    <nav className='flex flex-col gap-12 justify-center items-center py-32'>
