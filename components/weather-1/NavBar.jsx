...
const className = 'px-4 h-12 w-[calc(100%-8px)] -ml-[8px] text-gray-600 flex justify-center items-center border-l-8 hover:border-gray-900 transition-all';

const NavBar = () => {
  return (
    <nav className='flex flex-col gap-8 justify-center items-center py-24'>
